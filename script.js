// Though TMDB urls for different usecases
...
// The search bar functionality by directly modifying DOM elements instead of providing a search list
// after that working faster than above method
searchInput.addEventListener('keyup', function() {
    //get the input string..
    var searchedInput = searchInput.value;
    // after that make api call with this url which wil return result array of matched titles and later we pass this json to create dom elements 
...
//disable the previous page button initially and then based upon page no 
